    ...
    <div class="layout">
        <Row type="flex" style="position:absolute;left:0;top:0;width:100%;">
            <Col span="4" class="layout-menu-left">
                ...
                <!--</Menu>-->
                <template>
                    <Menu active-name="1-2" @on-select="navigateTo">
                        <Submenu name="1">
                            <template slot="title">
                        ...
                        <Submenu name="2">
                            ...
                            <Submenu name="2-0">
                                ...
                                <MenuItem name="2-0-1">option 7</MenuItem>
                                <MenuItem name="2-0-2">option 8</MenuItem>
                            </Submenu>
                        </Submenu>
                        <Submenu name="3">
                            <template slot="title">
            ...
            <Col span="20">
                ...
                <div class="layout-breadcrumb">
                    <Breadcrumb>
                        <BreadcrumbItem to="/base/welcome">返回首页</BreadcrumbItem>
                        <BreadcrumbItem v-for="item in breadcrumbData" :to="item.url" :key="item.id">{{item.name}}
                        </BreadcrumbItem>
                    </Breadcrumb>
                </div>
