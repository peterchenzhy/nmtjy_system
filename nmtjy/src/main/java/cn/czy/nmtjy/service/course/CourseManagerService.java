...
public class CourseManagerService {
    ...
    private final static SimpleDateFormat sdf = new SimpleDateFormat("HHmmssSSS");
     ...
     * @modifier PeterChen
     * @version v1
     * @since 2019/3/30 17:15
     */
    private static String generateCode(int year, int area, int courseType) {
        StringBuilder sb = new StringBuilder();
        String yearStr = String.valueOf(year);
        String areaStr = "000" + String.valueOf(area);
        String courseTypeStr = "000" + String.valueOf(courseType);
        sb.append(yearStr.substring(yearStr.length() - 2, yearStr.length()))
                .append(areaStr.substring(areaStr.length() - 2, areaStr.length()))
                .append(courseTypeStr.substring(courseTypeStr.length() - 2, courseTypeStr.length()))
    ...
    public static void main(String... args) {
        System.out.println(generateCode(2019, 1, 1));
        System.out.println(generateCode(2019, 01, 01));
    }
}
